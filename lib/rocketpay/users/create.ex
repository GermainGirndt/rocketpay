defmodule Rocketpay.Users.Create do
  ...
  def call(params) do
    # Before (just for creating a new user, without assigned account):
    # params
    #   |>User.changeset()
    #   |>Repo.insert()
    ...
    ##################
    # We use Multi for a transaction containing multiple database operations
    # the first parameter (:create_user) is the name of the operation
    Multi.new()
